...
/**
 * The data room: Telarchy's own books, prose and numbers in one public read.
 *
 ...
 * visitor can fetch the same URL the page fetches and check it.
 */
  ...
  const body = {
    ...
    evidence: {
      ...
      shipping: {
        ...
        changes: CHANGES,
        total: TOTAL_CHANGES,
        /** The deploy that generated the log. Older than the page's own
