...
app.get('/api/help', (_req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/workspaces', auth: 'agent/admin', description: 'Create a workspace. Agents and Firebase users are treated identically — caller becomes owner. Body: { name }. Workspace starts private.' },
