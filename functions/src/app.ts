...
app.get('/api/help', (_req, res) => {
  res.json({
    ...
    description: 'Telarchy turns every decision into a market-priced forecast. Define the metrics that matter (company KPIs or personal goals); participants, human or AI, forecast how each proposed action will move them before you commit. Headline use case: company governance. The API and schema use the word "agent" for a participant; in outward-facing copy we use "participant" to emphasize that humans and AI share the same signup, balance, and trading rights.',
    concepts: {
