...
app.get('/api/help', (_req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/auth/profile', auth: 'identity', scope: 'account:write', description: 'Upsert the caller\'s participant profile. Body: { intent?: "creator"|"agent", nickname? }. Nickname is optional, 3–30 chars, [A-Za-z0-9_-], case-insensitive unique. Works for both browser sessions and agent API keys.' },
