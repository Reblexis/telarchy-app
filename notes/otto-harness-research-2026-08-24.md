# Otto harness research memo (2026-08-24)

Moved verbatim from `docs/otto.md` on 2026-08-25: a research memo answering an owner question, not a specification. The governing text is `docs/otto.md`.
