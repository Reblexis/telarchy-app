...
const expectedSchema: Record<string, string[]> = {
  ...
  agents: ['id', 'api_key_hash', 'role', 'auth_user_id', 'balance', 'earned_betting', 'spent_betting', 'spent_tokens', 'earned_tasks', 'wallet_address', 'withdrawn_usdc', 'platform_admin', 'intent', 'created_at', 'approved_at'],
  ...
  markets: ['id', 'workspace_id', 'metric_id', 'metric_name', 'target_date', 'resolved', 'resolved_at', 'actual_value', 'active', 'voided', 'created_at', 'range_min', 'range_max', 'shares', 'liquidity', 'pool', 'task_id'],
  ...
  tasks: ['id', 'workspace_id', 'proposed_by', 'title', 'description', 'price', 'status', 'conditional_market_ids', 'created_at'],
  task_messages: ['id', 'workspace_id', 'task_id', 'from', 'content', 'created_at'],
