...
| `proposal_closed` | 400 | The proposal was decided or its deadline passed; both branches are closed, buys and sells alike. Positions settle at the date. | Stop. Never retry. |
