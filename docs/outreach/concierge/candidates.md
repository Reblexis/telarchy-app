...
|---|------|-------------------|--------|-----------|--------|
| 1 | Jiří Helmich | Founder, B2B Minds (ex-Mews CPO 2019-2023) | warm | Real KPIs, real decisions at Mews; B2B Minds thesis is on-thesis with Telarchy alignment-layer framing | Call held 2026-05-13. Switched to tykání post-FCTC. Offered intros to Martin Nečaský (separate) and Jan Černý (Pale Fire Capital). 2026-05-16: Viktor shared Černý pre-read for vetting. 2026-05-17: Jirka's feedback returned, three items: (a) wants a demo/walkthrough before sending to Jan; (b) explicit IP disclosure about sharing with Jan; (c) substantive $100-test antipattern delineation request, addressed in `docs/go-to-market.md` "Why Telarchy is not the $100-test antipattern". Verbatim in `sent-dms/helmich-feedback-2026-05-17.md`. |
