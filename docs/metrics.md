...
### Profitable forecasters (`profitableForecasters`)

Participants whose trading profit, marked to market, is at least 100 credits over the markets that resolved in the trailing 30 days plus every market still open, house excluded. An open position is valued at what the market currently calls, so unsettled profit counts. Bots count exactly like humans; nobody has to link anything.
