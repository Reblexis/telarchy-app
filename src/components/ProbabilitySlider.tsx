  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '4px', width: '120px' }}>
      ...
      <div style={{ flex: 1, height: '8px', background: 'var(--border-color)', borderRadius: 'var(--radius-sm)', position: 'relative' }}>
        {prevPct !== undefined && (
          <div style={{ position: 'absolute', left: 0, top: 0, height: '100%', width: `${prevPct}%`, background: 'var(--accent-color, #3b82f6)', borderRadius: 'var(--radius-sm)', opacity: 0.25 }} />
        )}
        <div style={{ position: 'absolute', left: 0, top: 0, height: '100%', width: `${pct}%`, background: 'var(--accent-color, #3b82f6)', borderRadius: 'var(--radius-sm)' }} />
        ...
        {prevPct !== undefined && prevPct !== pct && (
          <div style={{ position: 'absolute', left: `${prevPct}%`, top: '-3px', width: '2px', height: '14px', background: 'var(--accent-color, #3b82f6)', borderRadius: '4px', transform: 'translateX(-50%)', opacity: 0.6 }} />
        )}
      </div>
